...
Tops = Frame(root,bg='gold',bd=20,pady=5,relief=RIDGE)
Tops.pack(side=TOP)
...
Buttons_F=Frame(ReceiptCal_F,bg='gold',bd=3,relief=RIDGE)
Buttons_F.pack(side=BOTTOM)

Cal_F=Frame(ReceiptCal_F,bg='gold',bd=6,relief=RIDGE)
Cal_F.pack(side=TOP)

Receipt_F=Frame(ReceiptCal_F,bg='gold',bd=4,relief=RIDGE)
Receipt_F.pack(side=BOTTOM)

MenuFrame = Frame(root,bg='gold',bd=10,relief=RIDGE)
MenuFrame.pack(side=LEFT)
Cost_F=Frame(MenuFrame,bg='gold',bd=4)
Cost_F.pack(side=BOTTOM)
Drinks_F=Frame(MenuFrame,bg='gold',bd=4)
Drinks_F.pack(side=TOP)


Drinks_F=Frame(MenuFrame,bg='gold',bd=4,relief=RIDGE)
Drinks_F.pack(side=LEFT)
Food_F=Frame(MenuFrame,bg='gold',bd=4,relief=RIDGE)
...
###########################################ToTal Cost################################################################################
lblCostofDrinks=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Drinks\t',bg='gold',
...
lblCostofFood=Label(Cost_F,font=('arial',14,'bold'),text='Cost of Foods  ',bg='gold',
                fg='black',justify=CENTER)
...
lblServiceCharge=Label(Cost_F,font=('arial',14,'bold'),text='Service Charge',bg='gold',
                fg='black',justify=CENTER)
...
lblPaidTax=Label(Cost_F,font=('arial',14,'bold'),text='\tPaid Tax',bg='gold',bd=7,
                fg='black',justify=CENTER)
...
lblSubTotal=Label(Cost_F,font=('arial',14,'bold'),text='\tSub Total',bg='gold',bd=7,
                fg='black',justify=CENTER)
...
lblTotalCost=Label(Cost_F,font=('arial',14,'bold'),text='\tTotal',bg='gold',bd=7,
                fg='black',justify=CENTER)
